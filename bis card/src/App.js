...
//   }
//   // const handleAddIcon = (id, icon) => {
//   //   const updatedPreviewData = [...previewData, icon]; // Push the JSX element to previewData
//   //   setPreviewData(updatedPreviewData);
//   //   // console.log(iconData);


    
//   //   const updatedIconData = iconData.map(item =>
...
//           {/* {console.log("   pd - "+previewData)} 
//           {console.log("   inpu - "+input)} 
//           {console.log("   icon - "+iconData)} 
//    { console.log("render "+rendericon)} */}
          

//           {/* <div className="flex flex-row mx-4 bg-red-600">
//             <LabelAndInput
//               label={'FirstName'}
//               text={firstName}
...
//             <LabelAndInput
//               label={'genderPronouns'}
//               text={genderPronouns}
//               setText={setGenderPronouns}
//             />
//             <LabelAndInput
//               label={'jobTitle'}
//               text={jobTitle}
...
//               setText={setBusinessAddress}
//             />
//             <LabelAndInput
//               label={'businessDescription'}
//               text={businessDescription}
//               setText={setBusinessDescription}
//             />
...
//                 {iconData.map((icon)=>(icon.isVisible)?(
//                 <div className='w-[48%] '>
//                   <button className=' border w-[100%] h-8   ' onClick={()=>handleAddIcon(icon.id,icon)}>
//                     <div>{icon.icon}</div>
//                     <div>{icon.name}</div>
//                     </button>
//                 </div>):null
...
//       // [{id:1,text:[{position:position,text:""}],media:[{position:position,mediaLink:""}], product:[{position:position,image:"",productTitle:"",productDescription:"",productPrice:"",productButtonLink:"",productButtonLabel:"",}], embedMedia:[{position:position,embedCode:""}], position:[{position:position,type:""}] }]
      
//       [
//         {id:1,text:[{}],media:[{}], product:[{}], embedMedia:[{}], position:[{}] }
      
//       ]
      
//     )

//   console.log("fcon  "+fContent);
...
//             {fContent.map((content)=><div className='my-4'> <FeaturedContent key={content.id} orderOfrender={content.position}/></div>)}
...
//             {/* featuredContentArr.push((featuredContentArr.length)  +1) */}
//             {/* {function addFeaturedContent(){
//               featuredContentArr.push((featuredContentArr.length)  +1)
//               console.log(featuredContentArr);
//               return featuredContentArr.map((length)=><FeaturedContent key={length}/>)
//             }} */}
